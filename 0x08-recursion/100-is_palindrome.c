...
/**
  * _lenght - checking the length of a string
  * @s: is the string
  * Return: return the lenght of the string (Successful)
**/
int _lenght(char *s)
{
	if (*s == '\0')
 ...
 * @s: is the string
 * Return: 1 if is polindrome or 0 if not (sucess)
**/
...
/**
  * is_palindrome - if string a palindrome
  * @s: is the string
